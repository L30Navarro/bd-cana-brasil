...
| `idh_pais_educacao`  | NUMERIC | 4,3  |12 bytes| NOT NULL| N/D| Componente “Educação” do Índice de Desenvolvimento Humano (IDH) do país.|
| `idh_pais_longevidade` |NUMERIC | 4,3 |12 bytes| NOT NULL | N/D| Componente “Longevidade” do Índice de Desenvolvimento Humano (IDH) do país.|
| `id_pais`      | INTEGER | |20 bytes| FK |N/D| Código oficial de identificação do pais, conforme o identificador numérico atribuído pelo FMI.|

 <h6 style="text-align: center;"> Tamanho de dados em cada registro: 117.8 bytes </h6>

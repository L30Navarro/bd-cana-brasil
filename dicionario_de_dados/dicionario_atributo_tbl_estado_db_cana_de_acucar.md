...
|----------------------|----------------|-------------|------------|------------|------------|
| `id_estado`  | INTEGER   |4 bytes| PK| N/D| Código oficial de identificação do estado, conforme o identificador numérico atribuído pelo IBGE.|
| `estado`|VARCHAR|   até 50 caracteres    | NOT NULL| N/D|Nome oficial do estado, segundo o registro administrativo do país ao qual pertence.|

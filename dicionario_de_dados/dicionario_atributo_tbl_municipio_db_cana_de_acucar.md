...
| `longitude`      | NUMERIC | 9,6 |24 bytes| NOT NULL|N/D|Coordenada geográfica que indica a posição leste–oeste do município, conforme o sistema de referência geodésico oficial do país.|
| `altitude`  | NUMERIC| 12,6 |23.94 bytes   |  NOT NULL| N/D| Altitude oficial do município, medida em relação ao nível médio do mar, conforme o sistema geodésico adotado pelo país de origem.|
| `id_microrregiao`    | INTEGER | |  22 bytes  | FK|N/D| 	Código oficial de identificação da microrregião, conforme o identificador numérico atribuído pelo IBGE.|
| `id_estado`      | INTEGER | |20 bytes   | FK| N/D| 	Código oficial de identificação do estado, conforme o identificador numérico atribuído pelo IBGE.|
 ...
 <h6 style="text-align: center;"> Tamanho de dados em cada registro: 182.01 bytes </h6>
